...
document.addEventListener("DOMContentLoaded", function () {
  ...
  formCadastro.addEventListener("submit", function (event) {
    ...
    campos.forEach(function (campo) {
      var grupo = campo.closest(".input-group");
      var feedback = grupo.querySelector(".invalid-feedback");

      if (!campo.value.trim()) {
        campo.classList.add("is-invalid"); // 🔥 força borda vermelha (resolve Bootstrap)
  ...
  formCadastro.querySelectorAll("input").forEach(function (campo) {
    campo.addEventListener("input", function () {
      var grupo = campo.closest(".input-group");
      var feedback = grupo ? grupo.querySelector(".invalid-feedback") : null;
